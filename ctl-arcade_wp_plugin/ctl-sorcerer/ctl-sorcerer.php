<?php
    /*
    Plugin Name: CTL Arcade - The Sorcerer
    Plugin URI: http://www.codethislab.com/
    Description: The Sorcerer for CTL Arcade Wordpress Plugin.
    Version: 1.0
    ...
    */
    ...
    class CTLArcadeSorcerer {

        // variabili membro
        private $_szCompatibleArcadeVersion = "1";
        private $_szPluginDir               = "ctl-sorcerer";
        private $_szPluginName              = "The Sorcerer";
        private $_szAspectRatio             = "16:9";
        private $_bGameRankAvailable        = 1; // 1 yes, 0 no
        private $_szGameTags                = "android game, canvas, color match, html5, iOS GAME, match three, match-3, matching, matching game, mobile, mobile game, puzzle, puzzle game, Zuma, zuma balls";
    ...
    $g_oCTLArcadeSorcerer =  new CTLArcadeSorcerer();
